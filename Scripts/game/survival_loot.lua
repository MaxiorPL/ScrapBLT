...
local random_loot = {
	...
	{ uuid = obj_consumable_chemical,		chance = 70,	quantity = randomStackAmount3 },
	{ uuid = obj_consumable_fertilizer,		chance = 25,	quantity = randomStackAmount3 },
	...
	{ uuid = blk_glass,						chance = 20,	quantity = randomStackAmount20 },

	{ uuid = jnt_bearing, 					chance = 5,		quantity = randomStackAmount5 },
}

local random_epicloot = {
	{ uuid = obj_plantables_carrot, 		chance = 15,	quantity = randomStackAmountAvg5 },
	{ uuid = obj_plantables_redbeet, 		chance = 15,	quantity = randomStackAmountAvg5 },
	{ uuid = obj_plantables_tomato, 		chance = 15,	quantity = randomStackAmountAvg5 },
	{ uuid = obj_plantables_banana, 		chance = 10,	quantity = randomStackAmountAvg3 },
	{ uuid = obj_plantables_blueberry, 		chance = 10,	quantity = randomStackAmountAvg3 },
	{ uuid = obj_plantables_orange, 		chance = 10,	quantity = randomStackAmountAvg5 },
	...
	{ uuid = obj_consumable_gas,			chance = 60,	quantity = randomStackAmountAvg5 },
	{ uuid = obj_consumable_battery,		chance = 40,	quantity = randomStackAmount10	},
	...
	{ uuid = obj_consumable_inkammo,		chance = 25,	quantity = randomStackAmount30 },
	...
	{ uuid = blk_glass,						chance = 20,	quantity = randomStackAmount30 },

	{ uuid = jnt_bearing, 					chance = 10,	quantity = randomStackAmount5 },
}
...
local random_officeloot = {
	{ uuid = obj_consumable_component,		chance = 10,	quantity = randomStackAmount8 },
	...
	{ uuid = obj_consumable_inkammo,		chance = 65,	quantity = randomStackAmount30 },
	{ uuid = obj_consumable_glue,			chance = 65,	quantity = randomStackAmount5 },
}
...
local random_loot_startarea = {
	...
	{ uuid = obj_seed_redbeet,				chance = 20,	quantity = randomStackAmountAvg2 },
	{ uuid = obj_seed_tomato,				chance = 20,	quantity = randomStackAmountAvg2 },
	{ uuid = jnt_bearing,					chance = 10, 	quantity = randomStackAmountAvg5 },
}
...
lootTables.loot_crate_epic = {
	...
	selectOne = {
		{ uuid = obj_outfitpackage_common, 			chance = 40 },
		{ uuid = obj_outfitpackage_rare, 			chance = 50 },
		{ uuid = obj_outfitpackage_epic, 			chance = 30 },
		...
		{ uuid = jnt_suspensionoffroad_01, 			chance = 5 },
		{ uuid = jnt_suspensionsport_01, 			chance = 5 },
		{ uuid = jnt_interactive_piston_01, 		chance = 5 },
		...
		{ uuid = obj_interactive_logicgate, 		chance = 5 },
		{ uuid = obj_interactive_timer, 			chance = 5 },
		{ uuid = obj_interactive_gasengine_01, 		chance = 5 },
		{ uuid = obj_interactive_electricengine_01, chance = 5 },
		{ uuid = obj_interactive_controller_01, 	chance = 5 },
		{ uuid = obj_interactive_driverseat_01, 	chance = 5 },
		{ uuid = obj_interactive_seat_01, 			chance = 5 },
		{ uuid = obj_interactive_driversaddle_01, 	chance = 5 },
		{ uuid = obj_interactive_saddle_01, 		chance = 5 },
	},
...
lootTables.loot_crate_epic_warehouse = {
	slots = function() return 3 end,
	selectOne = {
		{ uuid = jnt_suspensionoffroad_03, 			chance = 3 },
		{ uuid = jnt_suspensionsport_03, 			chance = 3 },
		{ uuid = jnt_interactive_piston_04, 		chance = 2 },
		{ uuid = obj_interactive_gasengine_03, 		chance = 3 },
		{ uuid = obj_interactive_gasengine_04, 		chance = 2 },
		{ uuid = obj_interactive_gasengine_05, 		chance = 1 },
		{ uuid = obj_interactive_electricengine_03, chance = 3 },
		{ uuid = obj_interactive_electricengine_04, chance = 2 },
		{ uuid = obj_interactive_electricengine_05, chance = 1 },
		{ uuid = obj_interactive_controller_04, 	chance = 2 },
		{ uuid = obj_interactive_driverseat_03, 	chance = 3 },
		{ uuid = obj_interactive_driverseat_04, 	chance = 2 },
		{ uuid = obj_interactive_seat_03, 			chance = 3 },
		{ uuid = obj_interactive_seat_04, 			chance = 2 },
		{ uuid = obj_interactive_driversaddle_03, 	chance = 3 },
		{ uuid = obj_interactive_saddle_03, 		chance = 3 },
	},
...
lootTables.loot_crate_standard = {
	...
	selectOne = {
		...
		{ uuid = obj_outfitpackage_epic, 		chance = 3 },

		{ uuid = obj_consumable_component,		chance = 47, 	quantity = randomStackAmountAvg3 },
...
lootTables.loot_crate_startarea = {
	...
	selectOne = {
		...
		{ uuid = obj_consumable_component,		chance = 1, 	quantity = randomStackAmount3 },
		{ uuid = obj_resource_circuitboard,		chance = 1 },
		{ uuid = nil,							chance = 1 }, -- No loot from selectOne
	},
...
lootTables.loot_crate_standard_warehouse = {
	slots = function() return randomStackAmount( 1, 2, 3 ) end,
	selectOne = {
		{ uuid = obj_plantables_broccoli, 		chance = 1,		quantity = 3 },
		{ uuid = obj_plantables_pineapple, 		chance = 1,		quantity = 3 },
...
lootTables.loot_woc_milk = {
	slots = function() return 1 end,
	randomLoot = {
		{ uuid = obj_consumable_milk,			chance = 1, 	quantity = randomStackAmountAvg5 },
	}
}
...
lootTables.loot_glow_goop = {
	slots = function() return 1 end,
	randomLoot = {
		{ uuid = obj_resource_glowpoop,			chance = 1, 	quantity = randomStackAmount10 },
	}
}
...
lootTables.loot_totebot_green = {
	slots = function() return 1 end,
	randomLoot = {
		{ uuid = obj_resource_circuitboard,		chance = 1, 	quantity = 2 },
...
lootTables.loot_haybot = {
	...
	randomLoot = {
		...
		{ uuid = obj_resource_circuitboard,		chance = 4, 	quantity = 3 },
		{ uuid = obj_consumable_component,		chance = 5, 	quantity = randomStackAmount5 },
		{ uuid = obj_consumable_battery,		chance = 3, 	quantity = randomStackAmount3 },
	}
}
...
lootTables.loot_tapebot = {
	...
	randomLoot = {
		...
		{ uuid = obj_consumable_battery,		chance = 5, 	quantity = randomStackAmount8 },
	}
}
